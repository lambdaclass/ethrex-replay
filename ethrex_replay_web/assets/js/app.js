...
import {hooks as colocatedHooks} from "phoenix-colocated/ethrex_replay_web"
import topbar from "../vendor/topbar"

// Custom hooks for LiveView
const Hooks = {
  // LogStream hook for auto-scrolling log viewer
  LogStream: {
    mounted() {
      this.scrollToBottom()
    },
...
// Use cyan color to match our theme
topbar.config({barColors: {0: "#22d3ee"}, shadowColor: "rgba(0, 0, 0, .3)"})
